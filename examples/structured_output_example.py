...
async def main():
    ...
    try:
        ...
        print(
            "🔗 Binding Pydantic schema to the model (enforcing structured output)..."
        )
        ...
        print(f"\n❌ Error: {e}")
        print(
            "Note: Ensure your selected provider supports structured output (e.g. OpenAI gpt-3.5-turbo/gpt-4, or newer Ollama models)."
        )
